...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  // Envelope parameters
  //
  G4double env_sizeXY = 50*m, env_sizeZ = 100*m;
...
//  G4Material* world_mat = nist->FindOrBuildMaterial("G4_AIR");
  ...
  G4LogicalVolume* logicBox =
    new G4LogicalVolume(airBox,          //its solid
...
/*
  ...
  G4LogicalVolume* lwBox = 
    new G4LogicalVolume(waterBox,
	nist->FindOrBuildMaterial("G4_Pb"),
	"waterBox");

  G4VPhysicalVolume* pwBox = 
    new G4PVPlacement(0,
		    G4ThreeVector(0,0,env_sizeZ-1*m),
		    lwBox,
		    "waterBox",
		    logicBox,
		    false,
